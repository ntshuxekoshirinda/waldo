...
var GameController = function () {
    ...
    var GameController = _classThis = /** @class */ (function () {
        ...
        GameController_1.prototype.validate = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.gameService.validateClick(body.characterName, body.x, body.y)];
                });
            });
        };
    ...
    (function () {
        ...
        _validate_decorators = [(0, common_1.Post)('validate')];
